...
class FCAccessibilityMultiSeries extends FCAccessibilityLegendEnabled {
  ...
  makeMultiSeriesAccessible (bEvent) {
    ...
    const firstActivePlotIndex = dataSet.findIndex(i => i._state.visible === true);
    ...
    for (let i = 0; i < seriesLength; i++) {
      for (let j = 0; j < dataLength; j++) {
        ...
        this.addTabIndexAndSetAria(dataSet[i].components.data[j].graphics.element && dataSet[i].components.data[j].graphics.element.node, alternateTextsPlot, mergeDeep(this.chartPropertyMap, plotStat), i === firstActivePlotIndex && j === 0 ? '2' : '-1', 'img', {
          sIndex: i,
          pIndex: j
        });
